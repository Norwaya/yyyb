...
import UIKit
import CoreData
class Yyk4TableViewController: UITableViewController {
    ...
    func operateStr(str: String) -> String{
        return str.substring(to: str.index(str.startIndex, offsetBy: 7))
    }
    func queryById(id: String) -> Array<String>{
        ...
        do {
            ...
            request.predicate = NSPredicate.init(format: "id matches '(\(id))(([1-9][0-9][0-9])|([0][1-9][0-9])|([0][0][1-9]))(0){6,}' ")
